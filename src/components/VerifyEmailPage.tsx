...
const VerifyEmailPage: React.FC = () => {
  ...
  return (
    <div className={`${stylesCont.container} bg-gray-50 dark:bg-gray-900`}>
      <div className={`${stylesCont.formContainer} bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-8 rounded shadow text-center text-gray-800 dark:text-gray-100`}>
