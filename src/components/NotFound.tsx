...
const NotFound: React.FC = () => (
  <div className="min-h-[70vh] md:min-h-[75vh] lg:min-h-[80vh] flex flex-col items-center justify-center text-center px-4">
    ...
    <h1 className="text-6xl md:text-7xl lg:text-8xl font-extrabold text-primary-600 dark:text-primary-400 mb-3">
      404
    </h1>
    ...
    <p className="text-sm md:text-base text-gray-500 dark:text-gray-400 mb-8">
      Parece que esta página perdió la señal. Probá volver al inicio.
    </p>
    <Link
      to="/"
