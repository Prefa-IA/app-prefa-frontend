...
const PerimetroSection: React.FC<PerimetroSectionProps> = ({
  perimetro,
  informe,
  pageCounter,
  lbiLfiPageCounter,
...
const CompoundCroquisSection: React.FC<CompoundCroquisSectionProps> = ({
  croquis,
  pageCounter,
}) => {
  const { parentTableStyle } = useTablePersonalization();
...
const CompoundPerimetrosSection: React.FC<CompoundPerimetrosSectionProps> = ({
  perimetros,
  pageCounter,
}) => {
  const { parentTableStyle } = useTablePersonalization();
...
const CompoundPlanosIndiceSection: React.FC<CompoundPlanosIndiceSectionProps> = ({
  planosIndice,
  pageCounter,
}) => {
  const { parentTableStyle } = useTablePersonalization();
