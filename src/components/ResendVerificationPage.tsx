...
const ResendVerificationPage: React.FC = () => {
  ...
  return (
    <div className={`${stylesCont.container} min-h-screen pt-[90px] flex justify-center items-center w-full`}>
      <div className={`${stylesCont.formContainer} bg-white dark:bg-gray-800 p-4 sm:p-8 rounded shadow w-full sm:w-auto`}>
        <button type="button" onClick={() => navigate('/login')} className="text-gray-500 hover:text-gray-700 flex items-center mb-4">
          <ArrowLeftIcon className="w-5 h-5 mr-1" />
        </button>
        <p className="text-center text-md font-bold mb-4 text-gray-900 dark:text-gray-100">Para activar tu cuenta, ingresá tu correo electrónico y te reenviaremos el mail de verificación.</p>
