...
const ForgotPasswordPage: React.FC = () => {
  ...
  return (
    <div className={`${stylesCont.container} min-h-screen pt-[90px] flex justify-center items-start w-full`}>
      <div className={`${stylesCont.formContainer} bg-white dark:bg-gray-800 p-4 sm:p-8 rounded shadow w-full sm:w-auto`}>
        ...
        <p className="text-center text-md font-bold mb-4 text-gray-900 dark:text-gray-100">Ingresá tu correo electrónico y te enviaremos un enlace para restablecer tu contraseña.</p>
