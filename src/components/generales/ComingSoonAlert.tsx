          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              ...
              <p className="text-sm md:text-base text-blue-800 dark:text-blue-200 leading-relaxed">
                Nos encontramos en etapa de validación técnica. Aproveche hoy el uso gratuito de
                nuestra herramienta de búsqueda mientras finalizamos los detalles para el
                lanzamiento comercial. Manténgase atento a las próximas actualizaciones.
              </p>
            </div>
            <button
              onClick={handleClose}
