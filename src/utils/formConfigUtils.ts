...
export const createFieldValidator = (field: FormField) => (value: string): boolean => {
...
export const validateFormData = (data: Record<string, string>, fields: FormField[]): Record<string, string> => {
